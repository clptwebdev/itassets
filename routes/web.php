...
Route::group(['middleware' => 'auth'], function() {
    ...
    // Asset Routes (Doesn't include import routes)
    ...
    //Component Routes (Doesn't include import routes)
    ...
    //Accessory Routes (Doesn't include import routes)
    ...
    //Consumable Routes (Doesn't include import routes)
