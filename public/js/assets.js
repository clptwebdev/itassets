        ...
        function sendData(){
            ...
            xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xhttp.send(`name=${name.value}&manufacturer_id=${manufacturer_id.value}&model_no=${model.value}&depreciation_id=${depreciation_id.value}&eol=${eol.value}&fieldset_id=${fieldset.value}&notes=${notes.value}`); 
        }
