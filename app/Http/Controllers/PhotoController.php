...
//        $photos = Photo::all();
        ...
        if($page + 1 < $pages)
        {
            $html .= '<li class="page-item" ><a class="page-link" href = "#" onclick="getPhotoPage(' . $page++ . ')">' . $page++ . '</a ></li >';
        }

        if($page < $pages)
        {
            $html .= '<li class="page-item" ><a class="page-link" href = "#" onclick="getPhotoPage(' . $page++ . ')"> Next</a ></li >';
        }
