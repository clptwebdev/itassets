...
class SoftwareBusinessExport implements FromArray, WithHeadings, ShouldAutoSize, WithEvents, WithTitle, WithColumnFormatting {
    ...
    public function array(): array
    {
        ...
        foreach($softwares as $software)
        {
            ...
            $array['Purchased Cost'] = $software->purchased_cost;
            ...
            $array['Additions'] = $add ?? '-';
            $software->archived_cost ? $ac = $software->archived_cost : $ac = '0';
            $array['Disposals'] = $ac ?? '-';
            $array['Cost C/Fwd'] = $cf ?? '0.00';
            $array['Depn B/Fwd'] = $software->purchased_cost - $bf ?? '0.00';
            $array['Depn Charge'] = $bf - $cf ?? '-';
            $array['Depn Disposal'] = '-';
            $array['Depn C/Fwd'] = $software->purchased_cost - $cf ?? '0.00';

            if($nbvYear1 >= $software->purchased_date)
            {
                $array['NBV ' . $nbvYear1] = $software->depreciation_value_by_date($nbvYear1);
            } else
            {
                $array['NBV ' . $nbvYear1] = '-';
            }
            ...
            {
                $array['NBV ' . $nbvYear2] = $software->depreciation_value_by_date($nbvYear2);
            } else
            {
                $array['NBV ' . $nbvYear2] = '-';
            }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                $lastRow = $this->softwares->count() + 3;
