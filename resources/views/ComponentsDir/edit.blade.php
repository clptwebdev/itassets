    ...
    <x-form.layout :action="route('components.update', $data->id)" method="PATCH">
        ...
        <section>
            <p class="mb-4">Edit {{ $data->name}}, Component stored in the Apollo Asset Management System. Change
                            ...
                            to return the Components page. </p>
                                    ...
                                    <div class="col-12 col-md-6 p-4 mb-3">
                                        ...
                                        <div class="form-group">
                                            <x-form.select name="manufacturer_id" :models="$manufacturers"
                                                           selected="{{ $data->manufacturer_id ?? 0}}"/>
                                        </div>
                                        <div class="form-group">
                                            <x-form.input name="serial_no" formAttributes="required"
                                                          value="{{old('serial_no') ?? $data->serial_no}}"/>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 p-4 mb-3 ">
                                        ...
                                        <div id="supplierInfo" class="bg-light p-4">
                                            ...
                                            <div class="model_no py-2 px-4 text-center">
                                                @if($data->supplier()->exists())
                                                    {{$data->supplier->address_1 ?? 'Address Line 1'}}
                                                    , {{$data->supplier->city ?? 'City'}}
                                                    . {{$data->supplier->postcode, 'Post Code'}}
                                                @else
                                                    Address
                                                @endif
                                            </div>
