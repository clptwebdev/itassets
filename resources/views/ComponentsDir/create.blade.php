...
@section('content')
    <x-form.layout :action="route('components.store')">
        ...
        <section>
            <p class="mb-4">Adding a new Component to the asset management system. Enter the following information
                            and
                            click the 'Save' button. Or click the 'Back' button to return the Components page. </p>
