...
<table class="table  table-bordered p-1 mb-4" width="100%">
    ...
    <tr>
        <td rowspan="4" width="15%">
            ...
            @else
                <img src="{{asset('images/png/manufacturer_image.png')}}" width="100%" alt="{{$manufacturer->name}}">
            @endif
        </td>
        <td>{{ $manufacturer->name }}</td>
    </tr>
    <tr><td>{{ $manufacturer->supportUrl }}</td></tr>
    <tr><td>{{ $manufacturer->supportPhone }}</td></tr>
    <tr><td>{{ $manufacturer->supportEmail }}</td></tr>
</table>
