                ...
                <div class="card shadow h-100">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="eol" id="eol" value="{{ $assetModel->eol }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" rows="10" name="notes" id="notes">{{ $assetModel->notes }}</textarea>
                        </div>
