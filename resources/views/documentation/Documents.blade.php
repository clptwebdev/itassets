            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                <div class="card-body">
                    ...
                    <ol>
                        ...
                        <li>Secondly, Fill out your order number from the Asset.</li>
                        <li>Thirdly,When Adding the Asset to the system you will need a <strong>Unique</strong> asset tag number which is not already in the system</li>
                        <li>Fourth,Please select when the devices where purchased.</li>
                        <li>Fifth,You will need to a serial number corresponding to the device your adding.</li>
                        <li>Sixth,a purchase cost will be needed (No need to enter a '£' sign this will be done automatically)</li>
