...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            ...
            @endcan
            @can('delete', $archive)
                <form class="d-inline-block" id="form{{$archive->id}}" action="{{ route('archives.destroy', $archive->id) }}"
                    method="POST">
                @csrf
                @method('DELETE')
                <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-coral shadow-sm deleteBtn" data-id="{{$archive->id}}"><i
            ...
            <div class="card shadow h-100 pb-2" style="border-left: 0.25rem solid ;">
                ...
                <div class="card-body">
                    <div class="row no-gutters">
                        <div class="col-12"><p class="mb-4 ">Information regarding an 'Archived {{ ucfirst($archive->model_type)}}
                            , the details regarding its disposal along with the users that requested and approved the disposal request.</p>
                        <hr>
                        </div>
                        <div class="col-12">
                            <table class="table table-sm table-bordered table-striped">
                                ...
                                <tr>
                                    <td>Type:</td>
                                    <td><span class="btn btn-sm btn-lilac">{{ ucfirst($archive->model_type) }}</span></td>
                                </tr>
                                <tr>
                                    <td>Name:</td>
                                    <td>{{ $archive->name }}</td>
                    ...
                    <div class="row no-gutters">
                        <div class="mb-1">
                            <p class="mb-4 ">Information regarding the 'Archived {{ ucfirst($archive->model_type)}}
                                purchase order, you can find information about the purchase and the supplier.</p>
                            ...
                            <a href="mailto:{{$archive->supplier->email}}"><button class="btn btn-sm btn-blue"><i class="far fa-envelope"></i> Email Supplier</button></a>
                            @endif
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row no-gutters">
                            <div class="col mr-2">
                                <div class="mb-1">
                                    ...
                                    <table class="table table-sm table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <small>{{ \Carbon\Carbon::parse($archive->created_at)->format('d-m-Y')}}</small></td>
                                            </tr>
                                            <tr>
                                                <td>Approved By:</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <small>{{ \Carbon\Carbon::parse($archive->updated_at)->format('d-m-Y')}}</small></td>
                                            </tr>
                                            <tr>
                                                <td>Reasons:</td>
                                            </tr>
                                    ...
                                    <a href="mailto:{{ $archive->requested->email}}"><button class="btn btn-sm btn-blue"><i class="far fa-envelope"></i> Email Administrator</button></a>
                                    @endif
                                </div>
                            </div>
                        </div>
