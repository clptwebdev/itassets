    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            @elseif($request->status == 1)
                ...
                <small class="text-success"><i class="fas fa-check-circle"></i> This was approved by {{ $super->name}} on {{ \Carbon\Carbon::parse($request->created_at)->format("d/m/Y - H:i:s")}}</small> 
            @else
                @php($super = \App\Models\User::find($request->super_id))
