@extends('layouts.app')
@section('title', 'View Transfer Errors')
@section('css')
...
@section('content')
        ...
        <div>
            <form action="{{ route('export.transfer.errors')}}" method="POST">
                ...
                <div class="form-group">
                    <input type="hidden" class="import-control " name="assets"
                           id="assets" placeholder="" value="{{htmlspecialchars(json_encode($valueArray))}}">
                </div>
    ...
    <section>
        <p class="mb-4">You have some errors on your transfer import. They are all displayed below, you cannot edit the errors here but instead have to download the errors
            and import the failed rows. Click the download errors in the top right hand corner, this only downloads the failed row. All the rows that have been success will
                                ...
                                <td>
                                    <span id="id{{$line}}" class="tooltip-danger">
                                        <input type="text" maxlength="11"
                                           ...
                                           value="{{ $valueArray[$row]['id'] }}"
                                           placeholder="" required data-container='#id{{$line}}' data-placement='top'
                                ...
                                <td>
                                    <span id="asset_tag{{$line}}" class="tooltip-danger">
                                        <input type="text" maxlength="11"
                                           ...
                                           placeholder="" required data-container='#asset_tag{{$line}}' data-placement='top'
                                ...
                                <td>
                                    <span id="new_tag{{$line}}" class="tooltip-danger">
                                        <input type="text" maxlength="11"
                                           ...
                                           value="{{ $valueArray[$row]['new_tag'] }}"
                                           placeholder="" required data-container='#new_tag{{$line}}' data-placement='top'
                                ...
                                <td>
                                    <span id="serial_no{{$line}}" class="tooltip-danger">
                                        <input type="text"
                                           ...
                                           placeholder="" required data-container='#serial_no{{$line}}' data-placement='top'
                                ...
                                <td>
                                    <span id="location_from{{$line}}" class="tooltip-danger">
                                        <input type="text"
                                           ...
                                           value="{{ $valueArray[$row]['location_from'] }}"
                                           placeholder="" required data-container='#location_from{{$line}}' data-placement='top'
                                ...
                                <td>
                                    <span id="location_to{{$line}}" class="tooltip-danger">
                                        <input type="text"
                                           ...
                                           value="{{ $valueArray[$row]['location_to'] }}"
                                           placeholder="" required data-container='#location_to{{$line}}' data-placement='top'
                                ...
                                <td>
                                    <span id="date{{$line}}" class="tooltip-danger">
                                        <input type="text"
                                           ...
                                           value="{{ $valueArray[$row]['date'] }}"
                                           placeholder="" required data-container='#date{{$line}}' data-placement='top'
                                ...
                                <td>
                                    <span id="notes{{$line}}" class="tooltip-danger">
                                        <input type="text"
                                           ...
                                           value="{{ $valueArray[$row]['notes'] }}"
                                           placeholder="" required data-container='#notes{{$line}}' data-placement='top'
