            ...
            <table class="table" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{ $asset->warranty }} Month(s) -
                        <strong>{{ round(\Carbon\Carbon::now()->floatDiffInMonths($warranty_end)) }} Remaining</strong>
                    </td>
                </tr>
                    ...
                    <tr>
                        ...
                        <td>£{{ $asset->purchased_cost }} - (Current Value*: £{{ number_format($dep, 2)}})<br>
                            <small>*Calculated using Depreciation Model:</small><br><strong
                                class="font-weight-bold d-inline-block btn-sm btn-secondary shadow-sm p-1"><small>Laptop
                                                                                                                  and
                                                                                                                  Tablet</small></strong></p>
                        </td>
                    </tr>
                @endif
                @if($asset->donated == 1)
        ...
        @if($asset->location()->exists())
            ...
            <div class="w-100 d-block">
                ...
                <table class="table" width="100%">
                        ...
                        <tr>
                            <td class="text-center p-1">
                                <div style="width: 150px; overflow:hidden; margin-left: auto; margin-right: auto;">
                                    <img src="{{ asset($asset->location->photo->path)}}" width="100%"
                    ...
                    @endif
                    <tr>
                        <td style="color: {{$asset->location->icon}};"><strong>{{ $asset->location->name }}</strong>
                        </td>
                    </tr>
                    <tr>
                        <td>{{ $asset->location->address_1 }}</strong></td>
                    </tr>
                    @if($asset->location->address_2 != "")
                        <tr>
                            <td>{{ $asset->location->address_2 }}</strong></td>
                        </tr>
                    @endif
                    <tr>
                        <td>{{ $asset->location->city }}</td>
                    </tr>
                    <tr>
                        <td>{{ $asset->location->county }}</td>
                    </tr>
                    <tr>
                        <td>{{ $asset->location->postcode }}</td>
                    </tr>
                </table>
