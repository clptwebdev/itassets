                            ...
                            <div class="form-row">
                                <div class="col-12 col-sm-6 p-2 mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?php if ($errors->has('name')) {?> border border-danger<?php }?>" name="name"
                                            id="name" placeholder="" value="{{ old('name')}}" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="asset_tag">Asset Tag Number</label>
                                        <input type="text" class="form-control <?php if ($errors->has('asset_tag')) {?> border border-danger<?php }?>" name="asset_tag"
                                            id="asset_tag" placeholder="" value="{{ old('asset_tag')}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="serial_no">Serial Number</label><span class="text-danger">*</span>
                                        <input type="text" class="form-control <?php if ($errors->has('serial_no')) {?>border border-danger<?php }?>" name="serial_no"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control <?php if ($errors->has('audit_date')) {?>border border-danger<?php }?>"
                                ...
                                <div class="col-12 col-sm-6 bg-light p-2 mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?php if ($errors->has('order_no')) {?>border border-danger<?php }?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="supplier_id" class="form-control <?php if ($errors->has('supplier')) {?>border border-danger<?php }?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control <?php if ($errors->has('warranty')) {?>border border-danger<?php }?>"
