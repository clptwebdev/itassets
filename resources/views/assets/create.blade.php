    ...
    <x-form.layout id="createNewAsset" :action="route('assets.store')" >
        <x-wrappers.nav title="Add New Asset(s)" >
            ...
            <button id="createBtn" type="button" class="d-inline-block btn btn-sm btn-green shadow-sm p-2 p-md-1"><i
                    class="fas fa-save fa-sm text-white pr-md-1"></i><span class="d-none d-md-inline-block">Create</span>
            </button>
        </x-wrappers.nav >
        <section >
                        ...
                        <div class="card-body" >
                            ...
                            <ul id="tab-bar" class="nav nav-tabs" > 
                                <li class="nav-item active" >
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#model" role="tab"
                                       aria-controls="home" aria-selected="true" >Asset Model</a >
                                </li >
                                <li class="nav-item" >
                            ...
                            <div class="tab-content border-left border-right border-bottom border-gray"
                                ...
                                <div class="tab-pane fade p-2 pt-4" id="home" role="tabpanel"
                                    ...
                                    <div class="assets">
                                            ...
                                            @php($t = 0)
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-3">
                                                            <input type="text" class="form-control @if ($errors->has("name.{$i}"))  {!! 'border border-danger' !!} @endif" 
                                                            name="name[]" tabindex="{{ $t+1}}" value="{{ old('name')[$i]}}" />
                                                        </div>
                                                        <div class="col-2">
                                                            <input type="text" class="form-control @if ($errors->has("asset_tag.{$i}"))  {!! 'border border-danger' !!} @endif"
                                                             name="asset_tag[]" tabindex="{{$t+1}}" value="{{ old('asset_tag')[$i]}}" />
                                                        </div>
                                                        <div class="col-3">
                                                            <input type="text" class="form-control @if ($errors->has("serial_no.{$i}"))  {!! 'border border-danger' !!} @endif" 
                                                            name="serial_no[]" tabindex="{{$t+1}}" value="{{ old('serial_no')[$i]}}" />
                                                        </div>
                                                        <div class="col-3">
                                                            <input type="text" class="form-control" name="room[]" tabindex="{{$t+1}}" value="{{ old('room')[$i]}}" />
                                                        </div>
                                                        <div class="col-1">
                                                            <button type="button" class="btn btn-sm btn-coral m-1 asset-remove"><i class="fas fa-times"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endfor
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-3">
                                                        <input type="text" class="form-control @if ($errors->has('name.0'))  {!! 'border border-danger' !!} @endif"
                                                         name="name[]" tabindex="1" value="{{old('name[1]')}}" />
                                                    </div>
                                                    <div class="col-2">
                                                        <input type="text" class="form-control @if ($errors->has('asset_tag.0'))  {!! 'border border-danger' !!} @endif" 
                                                        name="asset_tag[]" tabindex="2" />
                                                    </div>
                                                    <div class="col-3">
                                                        <input type="text" class="form-control" name="serial_no[]" tabindex="3" />
                                                    </div>
                                                    <div class="col-3">
                                                        <input type="text" class="form-control" name="room[]" tabindex="4" />
                                                    </div>
                                                    <div class="col-1">
                                                        <button type="button" class="btn btn-sm btn-coral m-1 asset-remove"><i class="fas fa-times"></i></button>
                                                    </div>
                                    ...
                                    <button type="button" class="btn btn-sm btn-green add-asset">Add Antoher Instance</button>
                                </div>  
                                        ...
                                        <div class="col-12 col-md-6 p-4 mb-3" >
                                            <div class="form-group position-relative" >
                                                ...
                                                <input type="hidden" id="asset_model" name="asset_model"
                                                       class="form-control mb-3" readonly value="{{old('asset_model')}}">
                                                <input class="form-control @if ($errors->has("asset_model"))  {!! 'border border-danger' !!} @endif" type="text" name="find_model" id="findModel"
                                                       value="{{old('find_model')}}" autocomplete="off" placeholder="Search for Model" >
                                                <div id="modelResults"
                                                    ...
                                                    @if($model->fieldset()->exists() && $model->fieldset->fields()->exists())
                                                        @foreach($model->fieldset->fields as $field)
                                                            ...
                                                            <div class="form-group" >
                                                                ...
                                                                @switch($field->type)
                                                                    @case('Text'):
                                                                    <x-form.input :name="$field->name" value="{{old(str_replace(' ', '_', strtolower($field->name)))}}" :label="false" />
                                                                    @break
                                                                    @case('Textarea')
                                                                    ...
                                                                    <select type="text" class="form-control @if ($errors->has(str_replace(' ', '_', strtolower($field->name))))  {!! 'border border-danger' !!} @endif"
                                                                      name="{{str_replace(' ', '_', strtolower($field->name))}}" >

                                                                        @foreach($array as $key => $value)
                                                                            <option value="{{ $value }}" @if(old(str_replace(' ', '_', strtolower($field->name))) == $value ){{'selected'}}@endif>
                                                                                {{ $value}}
                                                                            </option >
                                                                        @endforeach
                                        ...
                                        <div class="col-12 col-md-6 p-4 mb-3" >
                                            ...
                                            <div class="form-group" >
                                                ...
                                                <div class="form-check mt-2 ml-1" >
                                                    <input class="form-check-input" type="checkbox" value="1" @if(old('donated') == 1) checked @endif
                                            ...
                                            <div class="form-group position-relative" >
                                                ...
                                                <input class="form-control" type="text" name="find_supplier"
                                                       id="findSupplier" value="{{old('find_supplier')}}" placeholder="Search for Supplier" >
                                ...
                                <div class="tab-pane fade p-2 pt-4" id="attributes" role="tabpanel"
                                    ...
                                    <div class="row" >
                                        <div class="col-12 p-4 mb-3" >
                                            ...
                                            <div class="form-row" >
                                                <x-form.select name="status_id" :models="$statuses" selected="{{old('status_id')}}" />
                                            </div >
                                        </div >
                                    </div >
                                </div >
