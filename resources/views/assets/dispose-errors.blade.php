@extends('layouts.app')
@section('title', 'View Disposal Errors')
@section('css')
...
@section('content')
    ...
    <section>
        <p class="mb-4">Below are the rows that failed to dispose the requested assets. They are all displayed below, you cannot edit the errors here but instead have to download the errors
                                ...
                                <td>
                                    <span id="location_id{{$line}}" class="tooltip-danger">
                                        <input type="text"
                                           ...
                                           value="{{ $valueArray[$row]['location_id'] }}"
                                           placeholder="" required data-container='#location_id{{$line}}' data-placement='top'
                                ...
                                <td>
                                    <span id="reason{{$line}}" class="tooltip-danger">
                                        <input type="text"
                                           ...
                                           value="{{ $valueArray[$row]['reason'] }}"
                                           placeholder="" required data-container='#reason{{$line}}' data-placement='top'
