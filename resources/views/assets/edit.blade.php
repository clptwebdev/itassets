                                        ...
                                        <div class="col-12 col-md-6 p-4 mb-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="serial_no"
                                                    id="serial_no" placeholder="" value="{{ old('serial_no') ?? $asset->serial_no}}">
                                            </div>
                                            @php
                                                if(old('model_id')){
                                            ...
                                            @endphp
                                            <div id="additional-fields" @if($asset->model()->exists() && $model->fieldset_id == 0){{ 'style="display: none;"'}}@endif class="border border-gray p-2 mb-3">
                                        ...
                                        <div  class="col-12 col-md-6 p-4 mb-3 ">
                                            <div id="modelInfo" class="bg-light p-4">
                                                ...
                                                <div class="model_no py-2 px-4">
                                                    ...
                                                    Depreication: {{ $asset->model->depreciation->name}} ({{$months}} months)
                                                </div>
                                                <div class="model_no py-2 px-4">
                                        ...
                                        <div class="col-12 col-sm-6 p-4 mb-3">
                                            ...
                                            <div class="form-group">
                                                <label for="purchased_date">Purchased Date<span
                                                        ...
                                                        <?php if(old('purchased_date')){ $date=old('purchased_date');}else{$date= $asset->purchased_date;} ?>
                                                        <input type="date"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 p-4 mb-3 ">
                                            <div id="locationInfo" class="bg-light p-4">
                                                ...
                                                <div class="model_no py-2 px-4 text-center">
                                                    {{ $asset->location->address_1}}, {{$asset->location->city}}, {{ $asset->location->postcode}}
                                                </div>
                                                @endif
                                                <div class="model_no py-2 px-4 text-center">
                                    ...
                                    <div class="row">
                                        <div class="col-12 p-4 mb-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php if(old('audit_date')){ $date=old('audit_date');}else{$date= $asset->audit_date;} ?>
                                                <input type="date"
