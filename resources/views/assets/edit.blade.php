...
@section('content')
    <form action="" method="POST">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit #{{$asset->asset_tag}} Asset</h1>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div type="text"
                                         class="form-control bg-gray-300 <?php if ($errors->has('name')) {?>border-danger<?php }?>"
                                         name="asset_tag" id="asset_tag" placeholder=""
                                         required>{{$asset->asset_tag}}</div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select type="text"
                                            ...
                                            @foreach($locations as $location)
                                                <option @if($asset->location->id == $location->id) {{"selected"}}@endif>{{$location->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="manufacturer_location">Device Manufacturer</label><span
                                            class="text-danger">*</span>
                                        <select type="text"
                                                class="form-control mb-4 <?php if ($errors->has('manufacturer_location') || $errors->has('manufacturer_location')) {?>border-danger<?php }?>"
                                            ...
                                            @foreach($manufacturers as $manufacturer)
                                                <option @if($asset->manufacturer->id == $manufacturer->id) {{"selected"}}@endif>{{$manufacturer->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="date"
                                               ...
                                               value="{{Carbon\Carbon::parse($asset->purchased_date)->format('Y-m-d')}}">
                                    </div>
                                    <div class="form-group col-md-4">
