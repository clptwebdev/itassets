                                        ...
                                        <div class="col-12 col-md-6 p-4 mb-3 ">
                                            ...
                                            <div class="form-group position-relative">
                                                ...
                                                <input class="form-control" type="text" name="find_location"
                                                       id="findLocation" value="{{$property->location->name}}"
                                            ...
                                            <div class="form-group">
                                                <x-form.input name="depreciation" formAttributes="required"
                                                              value="{{ old('depreciation') ?? $property->depreciation}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="name">Property Type</label>
                                                <select id="type" name="type" class="form-control">
                                                    <option value="1" @if($property->type == 1) selected @endif>Freehold
                                                                                                                Land
                                                    </option>
                                                    <option value="2" @if($property->type == 2) selected @endif>Freehold
                                                                                                                Buildings
                                                    </option>
                                                    <option value="3" @if($property->type == 3) selected @endif>
                                                        Leasehold Land
                                                    </option>
                                                    <option value="4" @if($property->type == 4) selected @endif>
                                                        Leasehold Building
                                                    </option>
                                                </select>
                                            </div>
