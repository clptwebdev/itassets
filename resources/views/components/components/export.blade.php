        ...
        <div class="modal-content">
            ...
            <ul class="nav nav-tabs flex-column flex-sm-row justify-content-center">
                <li class="nav-item ml-2">
                    <a class="nav-link active list-group-item" aria-current="page" href="#" id="all-tab"
                       data-bs-toggle="tab" data-bs-target="#all" role="tab" aria-controls="all" aria-selected="true">By
                                                                                                                      Accessories</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link list-group-item" href="#" id="year-tab" data-bs-toggle="tab"
                       data-bs-target="#year" role="tab" aria-controls="year" aria-selected="false">By Assets</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link list-group-item" href="#" id="form-tab" data-bs-toggle="tab"
                       data-bs-target="#form" role="tab" aria-controls="form" aria-selected="false">By Components</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link list-group-item" href="#" id="teacher-tab" data-bs-toggle="tab"
                       data-bs-target="#teacher" role="tab" aria-controls="teacher" aria-selected="false">By
                                                                                                          Miscellaneous</a>
                </li>
            </ul>
                        ...
                        <div class="row m-auto d-flex justify-content-start align-items-center">
                            ...
                            @foreach($locations as $location)
                                <div class="col-2 p-1  d-flex p-1  d-flex">
                                    ...
                                    <label class="my-auto"
                                           for="location{{$location->name}}">{{ $location->name }}</label>
                                </div>
                            @endforeach
                        </div>

                        <div class="d-flex justify-content-center align-items-center g-3 m-auto mt-4">
                            <button type="submit" class="btn btn-primary m-2" type="button">
                                Get Accessories
                            </button>
                        </div>
                    </form>
