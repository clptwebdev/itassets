            ...
            <div class="row no-gutters" >
                ...
                <div class="col-12 col-sm-5 col-md-3 p-2" >
                    @if($miscellaneou->photo()->exists())
                        <img src="{{ asset($miscellaneou->photo->path) ?? asset('images/svg/misc-image.svg')}}"
                             width="100%" alt="{{$miscellaneou->name}}" >
                    @else
                ...
                <div class="col-12 col-sm-7 col-md-9 p-2" >
                    ...
                    <table class="table table-sm table-bordered table-striped" >
                        ...
                        <tr >
                            ...
                            <td class="text-right" >
                                <button class="btn btn-sm btn-blue p-1 font-weight-bold" data-toggle="modal"
                                        data-target="#miscellaneouModalStatus" >Change Status
                                </button >
                            </td >
                        </tr >
                    </table >
                            ...
                            <tr >
                                <td >
                                    @foreach($miscellaneou->category as $category)
                                        <strong
                                            class="font-weight-bold d-inline-block btn-sm btn-lilac shadow-sm p-1 m-2" ><small >{{ $category->name}}</small ></strong >
                                    @endforeach
                                </td >
                            </tr >
                        </table >
