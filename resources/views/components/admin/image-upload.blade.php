    ...
    <div class="formgroup mb-2 p-2">
        ...
        @if($model->photo()->exists())
            <img id="profileImage" onclick='getPhotoPage(1)'
                 src="{{ asset($model->photo->path) ?? asset('images/svg/accessory_image.svg')}}" width="100%"
                 alt="Select Profile Picture" data-bs-toggle="modal" data-bs-target="#imgModal">
        @else
            <img id="profileImage" onclick='getPhotoPage(1)' src="{{ asset('images/svg/accessory_image.svg') }}"
