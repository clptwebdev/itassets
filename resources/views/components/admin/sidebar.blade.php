...
<!-- Divider -->
    ...
    <!-- Nav Item - Utilities Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed text-left text-sm-center text-md-left" href="{{ route('components.index')}}"
               data-toggle="collapse" data-target="#accessoryDD" aria-expanded="true" aria-controls="accessoryDD">
    ...
    <!-- Nav Item - Utilities Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed text-left text-sm-center text-md-left" href="{{ route('components.index')}}"
               data-toggle="collapse" data-target="#componentsDD" aria-expanded="true" aria-controls="componentsDD">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed text-left text-sm-center text-md-left" href="{{ route('miscellaneous.index')}}"
               data-toggle="collapse" data-target="#miscellaneousDD" aria-expanded="true"
        ...
        <li class="nav-item">
            ...
            <div id="settingPages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                ...
                @can('view' , \App\Models\Backup::class)
                    <a class="collapse-item" href="/databasebackups">Database
                                                                     Backups</a>
                @endcan
