@props(['model'])
{{-- This is the Modal for Permanently deleting model types --}}
{{-- The model type is passed throug the Modal and is only referenced as text--}}
...
<div class="modal-dialog modal" role="document">
   <div class="modal-content">
       <div class="modal-header">
           <h5 class="modal-title" id="permDeleteModalLabel">Are you sure you want to permanently delete this {{$model}}?
           </h5>
