@props(['route'=>'/','inputName' => 'csv' , 'title'=>'' ]){{-- This is the Modal for Bulk options {SC} --}}
<div class="modal fade bd-example-modal-lg" id="bulk{{ucfirst($title)}}Modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <form action="{{$route}}" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <input class="form-control shadow-sm" type="file" placeholder="Upload here" name="{{$inputName}}"
                           accept=".csv" id="{{lcfirst($title)}}Assets" required>
                </div>
