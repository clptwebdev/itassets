    ...
    <div id="Sort" class="col-5">
        <form class="form-inline" method="POST" action="{{ route($route.'.filter')}}">
            ...
            <select class="form-control mr-2" name="orderby">
                ...
                <option value="name desc" @if(session('orderby') == 'name' && (session('direction')) == 'desc') selected @endif>Name (Z-A)</option>
                ...
                <option value="supplier_name asc" @if(session('orderby') == 'supplier_name' && (session('direction')) == 'asc') selected @endif>Supplier (A-Z)</option>
                <option value="supplier_name desc" @if(session('orderby') == 'supplier_name' && (session('direction')) == 'desc') selected @endif>Supplier (Z-A)</option>
                @if($model === 'Asset')
                ...
                <option value="audit_date desc" @if(session('orderby') == 'audit_date' && (session('direction')) == 'desc') selected @endif>Audit Date (Latest to Earliest)</option>
                @endif
            </select>
