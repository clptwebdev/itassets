...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4"><?php  ?>
        ...
        <div>
            <form action="accessories/export-import-errors" method="POST">
                ...
                <a href="/accessories" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i
    ...
    <section>
        <p class="mb-4">Below are the different Import Failures of all the different accessories stored in the management
            system. Each has
            ...
            <div class="modal-content">
                ...
                <form action="/importmanufacturer" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="https://clpt.sharepoint.com/:x:/s/WebDevelopmentTeam/EWmxI4Q89eVMjPBSGed7QVQBa6Vk_gZFq_xPip9bTUx5rQ?e=I8bphs" target="_blank" class="btn btn-info" >
