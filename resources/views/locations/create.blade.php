    ...
    <form action="{{ route('location.store') }}" method="POST">
        ...
        <section>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       name="address_1" id="address_1" placeholder="Street Name" required>
            ...
            <div class="card shadow mt-4">
                ...
                <div class="card-body"><p>There are
                                          currently <?php $locationAmmount = \App\Models\Asset::all()->count() ?>{{$locationAmmount ?? 0}}
                                          Locations on the System</p></div>
