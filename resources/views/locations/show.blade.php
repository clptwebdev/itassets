...
@section('content')
        ...
        <div>
            ...
            @can('update', $location)
                <a href="{{ route('location.edit', $location->id)}}"
                   class="d-none d-sm-inline-block btn btn-sm bg-yellow text-white shadow-sm"><i
    ...
    <section>
        <p class="mb-4">Information regarding {{ $location->name }}, the assets that are currently assigned to the
                        location and any request information.</p>

        <div class="row pl-4 pr-2 mb-4">
            <div
                class="col-12 col-sm-4 col-md-3 col-xl-2 bg-white rounded overflow-hidden d-flex justify-content-center align-items-center"
                style="border: solid 3px {{ $location->icon ?? '#666'}};">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="progress progress-sm mr-2">
                                                <div class="progress-bar bg-coral" role="progressbar"
                                                     style="width: {{ ($ud/$total) * 100 }}%"
                                                     aria-valuenow="{{ ($ud/$total) * 100 }}" aria-valuemin="0"
            ...
            <div class="modal-content">
                <form action="{{ route('location.destroy', $location->id)}}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <small class="text-danger">**Warning this is permanent. All assets assigned to this location
                                                   will become
                                                   available.</small>
                    </div>
