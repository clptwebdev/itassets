                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6 p-4 mb-3 ">
                                            <div class="form-group">
                                                <x-form.input name="name" formAttributes=""
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="address_2" id="address_2"
                                                       ...
                                                       value="{{ old('address_2') ?? $location->address_2}}">
                                            </div>

                                            <div class="form-group">
                                                <x-form.input name="city" formAttributes=""
                                                              value="{{old('city') ?? $location->city}}"/>
                                            </div>

                                            <div class="form-group">
                                                <x-form.input name="county" formAttributes=""
                                                              value="{{old('county') ?? $location->county}}"/>
                                            </div>

                                            <div class="form-group">
                                                <x-form.input name="postcode" formAttributes=""
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control" name="telephone" id="telephone"
                                                       ...
                                                       value="{{ old('telephone') ?? $location->telephone}}">
                                            </div>
