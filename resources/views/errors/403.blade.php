...
@php
    switch($type){
        case 'asset':
          ...
          $name = $asset->model->name ?? $asset->asset_tag;
        ...
        case 'area':
          ...
          break;
        default:
          $message = "You don't have the adequate permission to fulfill this task.";
          $link = "/dashboard";
          break;
...
<div class="container text-center mt-4"><a href="{{$link}}"" class="btn btn-main p-2 text-center">Return to Button</a></div>
</body>
</html>
