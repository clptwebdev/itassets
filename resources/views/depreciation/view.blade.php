                        ...
                        @foreach($depreciation as $dep)
                            <tr>
                                ...
                                <td class="text-left   ">
                                    ...
                                    @endforeach
                                    <small
                                        class="bg-light border border-secondary rounded p-1 m-1 text-secondary showBtn pointer"
                                        data-id="{{$dep->id}}" data-name="{{$dep->name}}"
                                        data-route="{{ route('depreciation.show', $dep->id)}}"><i
                                            class="fas fa-ellipsis-h"></i></small>
                                </td>
                                <td class="text-right">
