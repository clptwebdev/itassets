                                    ...
                                    <div class="row" >
                                        <div class="col-12 col-md-6 p-4 mb-3 " >
                                            ...
                                            <div class="form-group" >
                                                <x-form.input name="name" formAttributes="required" value="{{$auc->name}}"/>
                                            </div >
                                            ...
                                            <div class="form-group" >
                                                <x-form.input name="value" formAttributes="required" value="{{$auc->value}}"/>
                                            </div >

                                            <div class="form-group" >
                                                <x-form.date name="date" formAttributes="required" value="{{\Carbon\Carbon::parse($auc->date)->format('Y-m-d')}}" />
                                            </div >

                                            <div class="form-group" >
                                                <x-form.input name="depreciation" formAttributes="required" value="{{ $auc->depreciation}}" />
                                            </div >
