                                    ...
                                    <div class="row" >
                                        <div class="col-12 col-md-6 p-4 mb-3 " >
                                            ...
                                            <div class="form-group" >
                                                <x-form.input name="name" formAttributes="required" value="{{old('name') ?? $auc->name}}"/>
                                            </div >
                                            <div class="form-group position-relative" >
                                                ...
                                                <input class="form-control" type="text" name="find_location"
                                                       id="findLocation" value="{{$auc->location->name}}" placeholder="Search for Location" autocomplete="off">
                                            ...
                                            <div class="form-group" >
                                                <x-form.input name="purchased_cost" formAttributes="required" value="{{old('purchased_cost') ?? $auc->purchased_cost}}"/>
                                            </div >

                                            <div class="form-group" >
                                                <x-form.date name="purchased_date" formAttributes="required" value="{{\Carbon\Carbon::parse($auc->purchased_date)->format('Y-m-d')}}" />
                                            </div >

                                            <div class="form-group" >
                                                <x-form.input name="depreciation" formAttributes="required" value="{{ old('depreciation') ?? $auc->depreciation}}" />
                                            </div >

                                            <div class="form-group">
                                                <label for="name">Property Type</label>
                                                <select id="type" name="type" class="form-control">
                                                    <option value="1" @if($auc->type == 1) selected @endif>Freehold Land</option>
                                                    <option value="2" @if($auc->type == 2) selected @endif>Freehold Buildings</option>
                                                    <option value="3" @if($auc->type == 3) selected @endif>Leasehold Land</option>
                                                    <option value="4" @if($auc->type == 4) selected @endif>Leasehold Building</option>
                                                </select>
                                            </div>
                                        </div >
                                        <div class="col-12 col-md-6 p-4 mb-3 " >
