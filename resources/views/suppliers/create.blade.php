...
<form action="{{ route('suppliers.store') }}" method="POST">
    ...
    <section>
        <p class="mb-4">Adding a new supplier to the asset management system. Enter in the following information and click the 'Save' button. Or click the 'Back' button
                ...
                <div class="card shadow h-100">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="url" name="url" value="" placeholder="https://">
                        </div>
