...
@section('content')
    <form action="{{ route('miscellaneous.update', $miscellanea->id) }}" method="POST">
        ...
        <section>
            <p class="mb-4">Edit a existing miscellanea to the asset management system. Enter in the following information
                and
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       name="name" id="name" placeholder="miscellanea Name" value="{{$miscellanea->name}}">
                            </div>
                            <div class="form-group">
                                <label for="serial_no">Serial_no</label>
                                <input type="text"
                                       class="form-control mb-3 <?php if ($errors->has('serial_no')){?>border-danger<?php }?>"
                                       name="serial_no" id="serial_no" value="{{$miscellanea->serial_no}}">
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text"
                                           ...
                                           id="order_no" name="order_no"  value="{{$miscellanea->order_no}}" required>
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date"
                                           ...
                                           id="purchased_date" name="purchased_date" value="{{ \Carbon\Carbon::parse($miscellanea->purchased_date)->format('Y-m-d')}}" required>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select type="text"
                                        ...
                                        @foreach($suppliers as $supplier)
                                            <option
                                                value="{{$supplier->id}}" @isset($miscellanea->supplier->id) @if($miscellanea->supplier->id == $supplier->id){{'selected'}} @endif @endisset >{{ $supplier->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="notes" id="notes" class="form-control" rows="10">{{$miscellanea->notes}}</textarea>
                            </div>
