...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4"><?php  ?>
        ...
        <div>
            <form action="{{route('miscellaneaexport.import')}}" method="POST" class="d-inline">
                ...
                @can('export' , \App\Models\Miscellanea::class)
            ...
            @can('viewAny' , \App\Models\Miscellanea::class)
                <a href="/miscellaneous" class="d-none d-sm-inline-block btn btn-sm btn-grey shadow-sm"><i class="fas fa-plus fa-sm te
    ...
    <section>
        <p class="mb-4">Below are the different Import Failures of all the different miscellaneous stored in the
                        management
                        system. Each has
            ...
            <div class="modal-content">
                ...
                <form action="/importmanufacturer" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="https://clpt.sharepoint.com/:x:/s/WebDevelopmentTeam/EbntKq_mlTVAgWc6TVyyomUBai1vGhqJFBJy9sULugmz_A?e=83Q40o"
