    ...
    <x-form.layout :action="route('accessories.update', $accessory->id)" method="PATCH">
        ...
        <section>
            <p class="mb-4">Edit {{ $accessory->name}} and change any of the following information. Click the 'Save'
                            button. Or click the 'Back' button to return the Accessories page. </p>
                                    ...
                                    <div class="col-12 col-md-6 p-4 mb-3">
                                        ...
                                        <div class="form-group">
                                            <x-form.select name="manufacturer_id" :models="$manufacturers"
                                                           selected="{{old('manufacturer_id') ?? $accessory->manufacturer_id}}"/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <x-form.input name="serial_no" formAttributes="required"
                                                          value="{{old('serial_no') ?? $accessory->serial_no}}"/>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 p-4 mb-3 ">
                                    ...
                                    <div class="col-12 col-md-6 p-4 mb-3">
                                        ...
                                        <div class="form-group">
                                            <x-form.input name="order_no"
                                                          value="{{old('order_no') ?? $accessory->order_no}}"/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <x-form.input name="purchased_cost" formAttributes="required"
                                                          value="{{old('purchased_cost') ?? $accessory->purchased_cost}}"/>
                                        ...
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="hidden" id="supplier_id" name="supplier_id"
                                                   ...
                                                   value="{{old('supplier_id') ?? $accessory->supplier_id}}">
                                            <input class="form-control" type="text" name="find_supplier"
                                                   id="findSupplier"
                                                   value="{{old('find_supplier') ?? $accessory->supplier->name ?? ""}}"
                                        ...
                                        <div class="form-group">
                                            <x-form.input name="warranty"
                                                          value="{{old('warranty') ?? $accessory->warranty}}"/>
                                        </div>
                                    </div>
                                        ...
                                        <div id="supplierInfo" class="bg-light p-4">
                                            ...
                                            <div class="model_no py-2 px-4 text-center">
                                                @if($accessory->supplier()->exists())
                                                    {{$accessory->supplier->address_1 ?? 'Address Line 1'}}
                                                    , {{$accessory->supplier->city ?? 'City'}}
                                                    . {{$accessory->supplier->postcode, 'Post Code'}}
                                                @else
                                                    Address
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-12 p-4 mb-3">
                                        ...
                                        <div class="form-row">
                                            <x-form.textarea name="notes" formAttributes="rows='10'"
                                                             value="{{old('notes') ?? $accessory->notes}}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
