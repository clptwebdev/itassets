                    ...
                    <div>
                        <div class="centred">
                            <form action="/login" method="POST" class="d-inline">
                                ...
                                <input class="form-control margin-10-bottom input-styles input-style-design" id="email"
                                       type="email" name="email" placeholder="Apollo@clpt.co.uk" required>
                                <label class=" fa-sm text-white-50">Password: </label>
                                <input class="form-control input-styles input-style-design" id="password"
                                ...
                                @endif
                                <button class="centred button margin-25-height font20 w-100 mt-4 border-0"> Log in
                                </button>
                            </form>
                        </div>
                    </div>
