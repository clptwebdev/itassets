...
@section('title', 'Add Furniture, Fixtures and Equipment')
...
@section('content')
    <x-form.layout :action="route('ffes.store')">
        ...
        <section>
            <p class="mb-4">Add Furniture, Fixtures and Equipment to the Apollo Asset Manager. </p>
