                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6 p-4 mb-3">
                                            ...
                                            <div class="form-group">
                                                <x-form.input name="order_no"
                                                              value="{{old('order_no') ?? $ffe->order_no}}"/>
                                            </div>
                                            <div class="form-group">
                                                <x-form.date name="purchased_date" formAttributes=""
                                                             value="{{old('purchased_date') ?? $ffe->purchased_date }}"/>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group position-relative">
                                                ...
                                                <input type="hidden" id="supplier_id" name="supplier_id"
                                                       ...
                                                       value="{{old('supplier_id') ?? $ffe->supplier_id}}">
                                                <input class="form-control" type="text" name="find_supplier"
                                                       id="findSupplier" value=""
                                                       value="{{old('find_supplier') ?? $ffe->supplier->name ?? ''}}"
                                            ...
                                            <div class="form-group">
                                                <x-form.input name="warranty"
                                                              value="{{old('warranty') ?? $ffe->warranty}}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6 p-4 mb-3 ">
                                            <div id="supplierInfo" class="bg-light p-4">
                                                <div
                                                    class="model_title text-center h4 mb-3">{{old('find_supplier') ?? $ffe->supplier->name ?? 'Supplier Name'}}</div>
                                                <div
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 p-4 mb-3 ">
                                            <div id="locationInfo" class="bg-light p-4">
                                                <div
                                                    class="model_title text-center h4 mb-3">{{ $ffe->location->name }}</div>
                                                <div
                                                    class="model_image p-4 d-flex justify-content-center align-items-middle">
                                                    @if($ffe->location()->exists() && $ffe->location->photo()->exists())
                                                        <img id="profileImage" onclick='getPhotoPage(1)'
                                                             src="{{ asset($ffe->location->photo->path) }}"
                                            ...
                                            <div id="categories" class="form-control h-auto p-4 mb-3 bg-light">
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <input type="hidden" id="category_id" name="category"
                                                           class="form-control mb-3" readonly
                                                           value="{{ implode(",",$ffe->category->pluck('id')->toArray())}}">
