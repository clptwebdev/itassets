                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="icon" class="form-control" id="update_icon">
                                <option value="far fa-circle" @if($status->icon == "far fa-circle"){{'selected'}}@endif>
                                    <i class="far fa-circle"></i> Doughnut
                                </option>
                                <option value="fas fa-circle" @if($status->icon == "far fa-circle"){{'selected'}}@endif>
                                    <i class="fas fa-circle"></i> Circle
                                </option>
                                <option value="fas fa-check" @if($status->icon == "far fa-check"){{'selected'}}@endif><i
                                        class="fas fa-check"></i> Tick
                                </option>
                                <option value="fas fa-times" @if($status->icon == "far fa-times"){{'selected'}}@endif><i
                                        class="fas fa-times"></i> Times
                                </option>
                                <option
                                    value="fas fa-skull-crossbones" @if($status->icon == "far fa-skull-crossbones"){{'selected'}}@endif>
                                    <i class="fas fa-skull-crossbones"></i> Cross Bones
                                </option>
                                <option value="fas fa-tools" @if($status->icon == "far fa-tools"){{'selected'}}@endif><i
                                        class="fas fa-tools"></i> Tools
                                </option>
                            </select>
                        </div>
