...
@section('content')
    <x-form.layout :action="route('broadbands.store')">
        <x-wrappers.nav title="Add broadband">
            <x-buttons.return :route="route('broadbands.index')">broadbands</x-buttons.return>
            <x-buttons.submit>Save</x-buttons.submit>
        </x-wrappers.nav>
        <section>
            <p class="mb-4">
                Add broadband to the Apollo Asset Manager. </p>
